describe('Validar pago de webpay', () => {

    context("Se realiza una compra de boletos, posteriormente se realiza la transaccion via webpay", () => {
   
        it('El pago debe ser verficado', () => {
